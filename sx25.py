...
def validate_session(cookies_dict):
    ...
    test_url = "https://securitytrails.com/_next/data/775a7486/list/apex_domain/example.com.json"
...
def get_securitytrails_data(resource_type, resource_value, page, cookies_dict, search_term=None, max_retries=5):
    ...
    api_paths = {
        'subdomain': f"/_next/data/775a7486/list/apex_domain/{resource_value}.json",
        'reverse_ip': f"/_next/data/775a7486/list/ip/{resource_value}.json",
        'reverse_mx': f"/_next/data/775a7486/list/mx/{resource_value}.json",
        'reverse_email': f"/_next/data/775a7486/list/email/{resource_value}.json",
        'reverse_ns': f"/_next/data/775a7486/list/ns/{resource_value}.json",
        'keyword': f"/_next/data/775a7486/list/keyword/{resource_value}.json"
    }
