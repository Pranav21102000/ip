...
def main():
    ...
    outfile = open(out_file, "a", buffering=1)

    written_domains = set()   # remove this if you want duplicates

    session = requests.Session()
    headers = {"User-Agent": "cidr_domain_scanner/3.1"}
    ...
    print(Fore.GREEN + f"\n[✔] Done. Domains saved live to: {out_file}")
